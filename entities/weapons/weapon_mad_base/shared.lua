...
// Is it a pistol, a rifle, a shotgun or a sniper? Choose only one of them or you'll fucked up everything. BITCH! (this should be a int, with each number representing a guntype DERP)
SWEP.Pistol				= false
SWEP.Rifle				= false
SWEP.Shotgun			= false
SWEP.Sniper				= false
...
function SWEP:Initialize()
	self:SetWeaponHoldType(self.HoldType or "")
